...
import com.coffee.house.enums.Roles;
...
public class User {
    ...
    @OneToMany(mappedBy = "userCartInfo", fetch = FetchType.LAZY, cascade = CascadeType.DETACH, orphanRemoval = true)
    private Set<OrderInfo> orderInfos;

    @OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "userComment")
    ...
    public boolean isRoleAdmin() {
        ...
        return userRole.stream()
                .anyMatch(role -> role.getName().equals(Roles.ADMIN.toString()));
    };
}